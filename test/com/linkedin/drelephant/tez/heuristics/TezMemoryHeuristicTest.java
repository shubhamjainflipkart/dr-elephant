...
public class TezMemoryHeuristicTest extends TestCase {

  private static Map<String, String> paramsMap = new HashMap<String, String>();
  private static Heuristic _heuristic = new TezMemoryHeuristic(new HeuristicConfigurationData("test_heuristic",
  ...
  private Severity analyzeJob(long taskAvgMemMB, long containerMemMB) throws IOException {
    ...
    p.setProperty(TezMemoryHeuristic.CONTAINER_MEMORY_CONF, Long.toString(containerMemMB));
