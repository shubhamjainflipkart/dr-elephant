...
/**
 * @author linkedin 
 * TezDataFetcher class is used to fetch the DAG data for hive and pig jobs  
 *
 */
public abstract class TezDataFetcher implements ElephantFetcher<TezDAGApplicationData> {
	private static final Logger logger = Logger.getLogger(TezDataFetcher.class);
	...
	public TezDataFetcher(FetcherConfigurationData fetcherConfData) {
