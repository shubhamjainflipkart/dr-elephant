...
public class TezVertexScopeTaskSpeedHeuristic implements Heuristic<TezDAGApplicationData> {
  private static final Logger logger = Logger.getLogger(TezVertexScopeTaskSpeedHeuristic.class);
  ...
  public TezVertexScopeTaskSpeedHeuristic(HeuristicConfigurationData heuristicConfData) {
